...
def build_source(name: str | None = None) -> HighsSource:
    """The data-source switch. `legacy` = scraped WSJ/Yahoo/stockanalysis;
    `xignite` = licensed feed. Unknown names are a hard error, never a
    silent default."""
